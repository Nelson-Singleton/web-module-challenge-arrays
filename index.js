...
function removeFlavorByName(arr, flavor){
    for(i = 0; i < arr.length; i++){ //iterate by 1.
        if(arr[i].includes(flavor)){ //at each iteration, check for a string at i'th position in the array.
            arr.splice(i, 1) //Remove the item if it includes the given string.
        }
    }
return arr;
...
function filterByWord(arr, searchString){
    newArr = [...arr];
